...
import { Text, CopyOnboardText } from '../component/text';
  ...
  <SplitBackground image="purple-gradient-bg" bottom={color.blackDark}>
    <MainContent>
      <View style={styles.wrapper}>
        ...
        <CopyOnboardText style={styles.title}>Pin saved!</CopyOnboardText>
        <Text style={styles.copy}>{'Your new pin is now saved.'}</Text>
      </View>
      <GlasButton onPress={() => nav.goSettings()}>Done</GlasButton>
    </MainContent>
  </SplitBackground>
);
